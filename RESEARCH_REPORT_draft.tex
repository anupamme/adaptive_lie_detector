...
\section{Adaptive Lie Detection Through Strategic
Interrogation}\label{adaptive-lie-detection-through-strategic-interrogation}

\textbf{A Mini-Research Investigation into Detecting AI Deception via
Behavioral Analysis}
...
See \texttt{data/results/complete\_experiments\_20251221\_144932.json}
and associated visualizations: - \textbf{Baseline Comparison}
(\texttt{baseline\_comparison\_20251221\_144932.png}): Real model
comparison showing 30\% efficiency gain - \textbf{Confidence
Trajectories} (\texttt{confidence\_trajectories\_20251221\_144932.png}):
Bimodal behavior---50\% confident early, 50\% never reach threshold -
\textbf{Stopping Distribution}
(\texttt{stopping\_distribution\_20251221\_144932.png}): 50\% early
stopping vs 50\% max questions - \textbf{Question Analysis}
(\texttt{question\_analysis\_20251221\_144932.png}): Detail probes
dominate (67\%), most effective strategy
...
\textbf{Real Model Configuration (Dec 21 2024)}: - \textbf{Target}:
...
\paragraph{Real Model Results (Dec 21
2024)}\label{real-model-results-dec-21-2024}
...
\paragraph{Real Model Results (Dec 21
2024)}\label{real-model-results-dec-21-2024-1}
...
\textbf{Visualization}: See
\texttt{data/results/baseline\_comparison\_20251221\_144932.png} for
comparison.
...
\paragraph{Real Model Results (Dec 21
2024)}\label{real-model-results-dec-21-2024-2}
...
\textbf{Visualization}: See
\texttt{data/results/question\_analysis\_20251221\_144932.png}.
...
\paragraph{Real Model Results (Dec 21
2024)}\label{real-model-results-dec-21-2024-3}
...
\textbf{Visualization}: See
\texttt{data/results/confidence\_trajectories\_20251221\_144932.png} and
...
\paragraph{Real Model Results (Dec 21
2024)}\label{real-model-results-dec-21-2024-4}
...
\subsubsection{D. Real Model Configuration (Dec 21
2024)}\label{d.-real-model-configuration-dec-21-2024}
...
\item
  \textbf{Visualizations}: \texttt{data/results/*.png}
\item
...
\emph{Real Model Validation (Dec 21 2024)}: - Meta Llama 3.3 70B (target
