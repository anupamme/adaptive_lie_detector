#!/bin/bash
# Setup script for g5.2xlarge instance - Qwen 2.5 14B experiment
# Run this after launching the instance

set -e

echo "=========================================="
echo "Instance 2: Qwen 2.5 14B Setup"
echo "=========================================="
...
echo "[4/8] Pulling qwen2.5:14b model (this may take 10-15 minutes)..."
...
echo "  tail -f logs/systemprompt_qwen14b_n200.log"
echo ""
echo "Check progress:"
echo '  grep "✓\|✗" logs/systemprompt_qwen14b_n200.log | wc -l'
echo ""
